            ...
            <section className="bg-light">
                <div className="container d-flex flex-column align-items-center justify-content-center min-vh-100 py-4">
                    <div className="mb-4 text-dark text-decoration-none d-flex align-items-center">
                        ...
                        <span className="h4 mb-0 fw-bold">Welcome Back</span>
                    </div>
                    <div className="card shadow-sm w-100" style={{ maxWidth: '400px' }}>
                        <div className="card-body p-4">
                            {/* <h1 className="h5 mb-4 fw-bold text-dark">Welcome Back</h1> */}
                            ...
                            <p className="mt-3 mb-0 text-muted">
                                Don't have an account yet? <Link to="/register" className="text-primary">Join Now</Link>
                            </p>
                        </div>
                    </div>
                </div>
