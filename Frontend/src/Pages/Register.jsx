...
formData.append('profilePic', value.image);
 // Corrected key
    ...
    <>
      ...
      <section className="bg-light">
        ...
        <div className="mb-4 text-dark text-decoration-none d-flex align-items-center">
                        ...
                        <span className="h4 mb-0 fw-bold">Create an account</span>
                    </div>
          <div className="card shadow-sm w-100" style={{ maxWidth: '400px' }}>
            <div className="card-body p-4">
              {/* <h1 className="h5  fw-bold text-dark"></h1> */}
                ...
                <div className=" text-center">
                  ...
                  <div className="d-flex justify-content-center ">
                    <img 
                      ...
                      alt="avatar" 
                      className="rounded-circle color-primary" 
                      width="100" 
                      height="100"
